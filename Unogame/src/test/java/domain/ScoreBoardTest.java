...
public class ScoreBoardTest {
    ...
    @Test
    public void toStringReturnsCorrectValues() {
        HashMap<Player, Integer> newScores = new HashMap<>();
        newScores.put(players.get(0), 20);
        newScores.put(players.get(1), 50);
        newScores.put(players.get(2), 4);
        ...
        assertEquals("Scores: \n"
                + " Player Kerttu: 4\n"
                + " Player Pekka: 20\n"
                + " Player Matti: 50", score.toString());
    }
}
